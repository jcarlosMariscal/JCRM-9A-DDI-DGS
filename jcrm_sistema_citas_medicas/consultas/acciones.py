...
class Acciones:
    ...
    -----------------------------------------""")
            ...
            print("\n <<<<<<No hay ninguna consulta en la agenda. Seleccione (a) agendar para agregar una. >>>>>>")
    ...
    def actualizar(self, doctor):
        ...
        if validar[0] != 0:
            ...
            print(f"\n <<<<<<No se encontró ninguna consulta con el nombre del pacientte [{nom_paciente}], verifique la ortografía >>>>")
    ...
    def modificar(self, doctor,nombre):
        ...
        if guardar[0] >= 1:
            ...
            print(f"\n<<<<< No se pudo modificar la consulta agendada del paciente, intente más tarde. >>>>>")
    ...
    def eliminar(self, doctor):
        ...
        if eliminar[0] >= 1:
            ...
            print("\n<<<<<< No se puedo eliminar la consulta, revisa la ortografía e intenta de nuevo más tarde. >>>>>")